...
uint256 hashGenesisBlock("0xd9a85347aafd9cee45130fe26171affb692ef3f282b752c086e4889dd248eb10");
...
{
        static const int64 BlocksTargetSpacing = 60; // 15 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
        ...
        if (fTestNet) {
                ...
                if (pindexLast->nHeight+1 >= 20000) { DiffMode = 2; }
        }
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Denarius miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd9a85347aafd9cee45130fe26171affb692ef3f282b752c086e4889dd248eb10");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Denarius";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398339290; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1309411;

        if (fTestNet)
        {
            block.nTime    = 1398339290;
            block.nNonce   = 1309411;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xba8d759fea765a2c1fa9db6202ac62490d47b31fbfe1835f2bdea426d631b299"));
