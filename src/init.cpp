...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        {
            // First part of help message is specific to Denarius server / RPC client
            std::string strUsage = _("Denarius version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  Denarius [options]                     " + "\n" +
                  "  Denarius [options] <command> [params]  " + _("Send command to -server or Denarius") + "\n" +
                  "  Denarius [options] help                " + _("List commands") + "\n" +
                  "  Denarius [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: Denarius.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 31334 or testnet: 31335)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 31333)") + "\n" +
...
//    }
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s.  Denarius is probably already running."), GetDataDir().string().c_str()));
    ...
    // requested to kill Denarius-qt during the last operation. If so, exit.
